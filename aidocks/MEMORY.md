...
- [Plan: storage upgrades](project_plan_storage_upgrades.md) — DONE in 3.6: softened overnight spoilage (main.table [spoilage]) + a Preservation shop (x37,y26–27) selling 4 tiered upgrades (icebox/pantry/sealed jars/covered jugs, 4 tiers at 20/40/60/80%, $5/$20/$40/$60) that multiply each ingredient's nightly loss down; owned tiers saved per game (main.table [storage]).
